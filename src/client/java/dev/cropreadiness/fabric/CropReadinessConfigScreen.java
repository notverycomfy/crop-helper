...
final class CropReadinessConfigScreen extends Screen {
    ...
    CropReadinessConfigScreen(Screen parent) { super(Component.literal("Crop Helper Colors")); this.parent = parent; }
    ...
    private void save() {
        ...
        try { CropReadinessConfig.save(values); minecraft.setScreenAndShow(parent); }
        catch (IOException exception) { status = "Could not save the configuration file"; }
    }
